...
\setlength{\columnheight}{91cm} % ------------------------------- od jakiej wysokości mają zaczynać się klocki, ale też miejsce dla tytułu autorów, afiliacji
...
% \begin{center}
  ...
  \begin{tabular}{ c{4cm} c{25cm} c{4cm} }

  \begin{figure}
  \includegraphics[width=0.07\columnwidth]{ibb.png}
  \end{figure} &                                           &
  \begin{figure}
  \includegraphics[width=0.11\columnwidth]{mslab.png}
  \end{figure}
...
<<echo=FALSE, warning=FALSE, error=FALSE, message=FALSE, fig.align="center">>=
 ...
 knitr::opts_chunk$set(out.width=900, out.height=300)
...
<<echo=FALSE, message=FALSE, warning=FALSE, error=FALSE, fig.align="center">>=
 ...
 knitr::opts_chunk$set(out.width=1000, out.height=250)
